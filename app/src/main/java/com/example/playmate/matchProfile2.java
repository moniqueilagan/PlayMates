...
public class matchProfile2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_profile2);

        name = getIntent().getExtras().getString("matchName");

        petName = findViewById(R.id.name_matchProfile_txt2);
        petBio = findViewById(R.id.bio_matchProfile_txt2);
        message_btn = findViewById(R.id.message_matchProfile_btn2);
        sendLayout = findViewById(R.id.constraintLayout4);
        send_btn = findViewById(R.id.send_matchProfile_btn2);
        messageTxt = findViewById(R.id.message_matchProfile_input2);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(matchProfile2.this,filteredMatches.class);
                startActivity(i);
            }
        });
